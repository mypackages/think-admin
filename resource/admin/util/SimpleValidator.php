...
class SimpleValidator
{
    ...
    public static function studentUsername($value, array $option = array())
    {
        $option = array_merge(
            array('minLength' => 2, 'maxLength' => 32),
            $option
        );
    ...
    public static function aUsername($value, array $option = array())
    {
        $option = array_merge(
            array('minLength' => 2, 'maxLength' => 32),
            $option
    ...
    {
        return (bool) preg_match('/^[\S]{6,20}$/u', $value);
    }

    public static function realname($value, array $option = array())
    {
        $option = array_merge(
            array('minLength' => 2, 'maxLength' => 20),
            $option
        );
